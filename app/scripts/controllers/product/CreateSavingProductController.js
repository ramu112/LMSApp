(function(module) {
  ...
  lms.ng.application.controller('CreateSavingProductController', ['$scope', 'ResourceFactory', '$location', lms.controllers.CreateSavingProductController]).run(function($log) {
