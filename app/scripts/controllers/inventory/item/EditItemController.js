(function(module) {
  ...
  mifosX.ng.application.controller('EditItemController', ['$scope', '$routeParams', 'ResourceFactory', '$location','$rootScope','webStorage', '$filter','dateFilter', mifosX.controllers.EditItemController]).run(function($log) {
