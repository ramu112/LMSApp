(function(module) {
  ...
  lms.ng.application.controller('ClientDocumentController', ['$scope', '$location', '$http', '$routeParams', 'API_VERSION','$upload','$rootScope', lms.controllers.ClientDocumentController]).run(function($log) {
