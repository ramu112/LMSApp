(function(module) {
  ...
  lms.ng.application.controller('ViewReportController', ['$scope', '$routeParams','ResourceFactory', '$location','$modal', lms.controllers.ViewReportController]).run(function($log) {
