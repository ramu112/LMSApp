(function(module) {
  ...
  lms.ng.application.controller('CreateDataTableController', ['$scope', '$routeParams','ResourceFactory', '$location', lms.controllers.CreateDataTableController]).run(function($log) {
