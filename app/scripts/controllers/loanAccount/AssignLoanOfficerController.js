(function(module) {
  ...
  lms.ng.application.controller('AssignLoanOfficerController', ['$scope', 'ResourceFactory', '$routeParams', '$location', 'dateFilter', lms.controllers.AssignLoanOfficerController]).run(function($log) {
