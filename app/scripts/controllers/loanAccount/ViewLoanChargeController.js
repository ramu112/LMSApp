(function(module) {
  ...
  lms.ng.application.controller('ViewLoanChargeController', ['$scope', 'ResourceFactory', '$routeParams', '$location','$modal', lms.controllers.ViewLoanChargeController]).run(function($log) {
