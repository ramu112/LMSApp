(function(module) {
  ...
  lms.ng.application.controller('ViewLoanTransactionController', ['$scope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter', lms.controllers.ViewLoanTransactionController]).run(function($log) {
