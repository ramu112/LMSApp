(function(module) {
  ...
  lms.ng.application.controller('AccCreateGLAccountController', ['$scope', 'ResourceFactory', '$location', lms.controllers.AccCreateGLAccountController]).run(function($log) {
