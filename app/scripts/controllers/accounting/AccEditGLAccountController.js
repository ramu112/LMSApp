(function(module) {
  ...
  lms.ng.application.controller('AccEditGLAccountController', ['$scope', '$routeParams', 'ResourceFactory', '$location', lms.controllers.AccEditGLAccountController]).run(function($log) {
