(function(module) {
    ...
    lms.ng.application.controller('AddMemberController', ['$scope', 'ResourceFactory', '$location','$routeParams','dateFilter', lms.controllers.AddMemberController]).run(function($log) {
