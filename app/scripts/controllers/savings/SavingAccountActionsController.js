(function(module) {
    ...
    lms.ng.application.controller('SavingAccountActionsController', ['$scope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter', lms.controllers.SavingAccountActionsController]).run(function($log) {
