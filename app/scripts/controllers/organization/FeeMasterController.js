(function(module) {
  ...
  mifosX.ng.application.controller('FeeMasterController', ['$scope','webStorage', 'ResourceFactory', '$location','$rootScope','$modal','$route', mifosX.controllers.FeeMasterController]).run(function($log) {
